...
function preparePrintVersion() {
    ...
    printGrid.querySelectorAll('.cw-cell').forEach(cell => {
        ...
        // Remove inline sizes to allow CSS scaling
        cell.style.width = '';
        cell.style.height = '';

        // Clear inputs unless solution is revealed
        const input = cell.querySelector('input');
    ...
    document.getElementById('print-grid-container').style.width = '100%';
    document.getElementById('print-grid-container').style.display = 'flex';
    document.getElementById('print-grid-container').style.justifyContent = 'center';
