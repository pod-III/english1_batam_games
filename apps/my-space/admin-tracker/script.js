  ...
  let html = `
    <div class="mb-10 p-5 bg-slate-50 dark:bg-slate-900/50 border-2 border-slate-200 dark:border-slate-800 rounded-2xl relative overflow-hidden">
      ...
      <div class="mb-4 flex gap-2">
        ...
        <button onclick="const i=document.getElementById('ca-input-${className.replace(/[^a-z0-9]/gi, '_')}'); addClassAdminTask('${className}', i.value); i.value='';" class="btn-chunky px-4 py-1.5 bg-blue text-white">Add</button>
      </div>
      <div class="space-y-2">
  ...
  html += `
    <div class="mb-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <button onclick="addSyllabusUnit('${className}')" class="btn-chunky px-3 py-1.5 bg-blue text-white">+ Add Unit</button>
      </div>
