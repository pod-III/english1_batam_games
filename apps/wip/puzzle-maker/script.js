...
// Inline HTML handlers (onchange, onclick) resolve functions against window.
// Explicitly assigning here guarantees availability regardless of how the
// script is loaded or whether a wrapper module affects top-level scope.
window.handleImageUpload    = handleImageUpload;
window.setAppMode           = setAppMode;
window.adjustGrid           = adjustGrid;
window.setPreset            = setPreset;
window.togglePuzzleStyle    = togglePuzzleStyle;
window.toggleHints          = toggleHints;
window.scramblePuzzle       = scramblePuzzle;
window.toggleSolve          = toggleSolve;
window.giveUp               = giveUp;
window.nextRound            = nextRound;
window.renameRound          = renameRound;
window.deleteRound          = deleteRound;
window.switchToRound        = switchToRound;   // use the patched version
window.clearStorage         = clearStorage;
window.closeModal           = closeModal;
window.openPrintModal       = openPrintModal;
window.toggleDarkMode       = toggleDarkMode;
window.toggleSidebar        = toggleSidebar;
window.executeWorksheetPrint = executeWorksheetPrint;
window.updateWorksheetPreview = updateWorksheetPreview;
